[![Build Status](https://travis-ci.com/mtumilowicz/java11-member-inner-class-compilation.svg?branch=master)](https://travis-ci.com/mtumilowicz/java11-member-inner-class-compilation)
